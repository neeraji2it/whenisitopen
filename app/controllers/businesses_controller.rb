class BusinessesController < ApplicationController
  ...
  def city_businesses
    ...
    @cities = Business.select('DISTINCT company_name').where("company_name ILIKE '#{params[:company_name]}%' or company_name LIKE '#{@name}%') and city = '#{session[:city]}'") if Rails.env == 'production'
